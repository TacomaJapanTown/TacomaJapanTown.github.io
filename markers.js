...
var marker1 = L.Marker.movingMarker(
  HarueOzaki,
  50000, {autostart: true, loop: true, icon: green}).addTo(mymap);
...
https://www.flaticon.com/free-icon/circle-shape-outline_25477#term=circle%20outline&page=1&position=1
  ...
  var marker2 = L.Marker.movingMarker(
    JuneMieko,
    50000, {autostart: true, loop: true, icon: blue}).addTo(mymap);
    ...
    L.polyline(JuneMieko,
      {color: '#045A8D', opacity: '0.8'}).addTo(mymap);

      //Fumi Sato's moving marker
      var marker3 = L.Marker.movingMarker(
        FumiSato,
        50000, {autostart: true, loop: true, icon: purple}).addTo(mymap);
        ...
        L.polyline(FumiSato,
          {color: '#54278F', opacity: '0.8'}).addTo(mymap);

          //Ryo Munekata's moving marker
          var marker4 = L.Marker.movingMarker(
            RyoMunekata,
            50000, {autostart: true, loop: true, icon: red}).addTo(mymap);
            ...
            L.polyline(RyoMunekata,
              {color: '#A50F15', opacity: '0.8'}).addTo(mymap);

              //Masaye Jinguji's moving marker
              var marker5 = L.Marker.movingMarker(
                MasayeJinguji,
                50000, {autostart: true, loop: true, icon: orange}).addTo(mymap);
                ...
                L.polyline(MasayeJinguji,
                  {color: '#E08214', opacity: '0.8'}).addTo(mymap);
